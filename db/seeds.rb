...
u3 = User.create(nick_name:"wolfhot2",first_name: "Jose David", last_name: "Arroyo Alvarez", email: "frijo50@gmail.com", password: "123456",admin: false,profile_photo:"https://www.dropbox.com/s/rj0i7rung87uoc6/pp.jpg?dl=0")
...
f2=Food.create(code_food: "cod-Gas",food_name:"Pepsi",cost_price: 500,sale_price: 1000,food_categories_id:2)
