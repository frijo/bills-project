...
class User < ActiveRecord::Base
  ...
  #has_attached_file :profile_photo,:default_url => "/asset/picture/:id/:style/:basename.:extension",:storage => :s3,:bucket => 'heroku-bills-project',:s3_credentials => S3_CREDENTIALS
